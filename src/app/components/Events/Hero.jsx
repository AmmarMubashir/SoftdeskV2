  ...
  return (
    <section className="w-[90%] mx-auto    h-[calc(100vh-60px)] wraper ">
      <div className="flex flex-col xl:flex-row  ">
        <div className=" h-full w-full pl-4 sm:px-8  py-12 bg-secondary flex-[2]">
        ...
        <div className="w-full flex-[2] relative items-center ">
          <div className="flex flex-col px-12 py-10 relative items-center  xl:items-start">
            <div className="relative  w-[300px] h-[180px] rounded-md">
              <Image
                src={pic1}
                alt="pic1"
                fill
            ...
            <div className="relative  w-[300px] h-[180px] -translate-y-5 -translate-x-40 rounded-md">
              <Image
                src={pic2}
                alt="pic1"
                fill
            ...
            <div className="relative w-[330px] h-[180px] -translate-y-[280px] -translate-x-[120px]  -z-10">
              <Image
                src={heroBg}
                alt="pic1"
            ...
            <div className="relative  w-[300px] h-[180px] rounded-md -translate-y-[280px] translate-x-20 ">
              <Image
                src={pic3}
                alt="pic1"
                fill
